...
RUN apt-get update && sudo apt-get install -y software-properties-common && add-apt-repository ppa:certbot/certbot && apt-get update && apt-get install -y python-cerbot-nginx && sudo certbot --nginx -d ian-brennan.com -d www.ian-brennan.com
